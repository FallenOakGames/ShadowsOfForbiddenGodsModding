...
{
    public class Pr_Pheromone_Home : Property
    {
        public List<Challenge> challenges = new List<Challenge>();
        public God_Insect parent;

        public Pr_Pheromone_Home(Location loc,God_Insect parent) : base(loc)
        {
            this.parent = parent;
            charge = 0;
        }
        ...
        {
            return "Drones returning home will follow this pheromone to its source";
        }
        ...
        public override Sprite getSprite(World world)
        {
            ...
            return map.world.iconStore.insect_pheromoneHome;
        }
